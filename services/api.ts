import { User, Persona, Seller, Post, Solution, InboxItem, AccessConfig, FeatureKey, Enterprise, SubscriptionPlan, CaseStudy, Testimonial, Collateral, CollateralType, Podcast, Event, Enquiry, MeetingRequest, MonetizationRule, DueDiligenceData, PlatformSettings } from '../types';
...
export const mockFilterOptions = {
    ...
    offerings: ['Ai Solution', 'SaaS Platform', 'Physical Product', 'Software', 'Hardware', 'Service', 'Sustainability', 'Robotics', 'Native AI', 'Business Coach'],
};

export const mockPlatformSettings: PlatformSettings = {
    valueChains: [...mockFilterOptions.valueChains],
    geographies: [...mockFilterOptions.geographies],
    industries: [...mockFilterOptions.industries],
    offerings: [...mockFilterOptions.offerings],
    scopes: [
        { id: 'all', label: "My Fav", description: "Content matching your interests across the platform", isEnabled: true },
        { id: 'connections', label: "Connections", description: "Content from your connections", isEnabled: true },
        { id: 'favourites', label: "Following", description: "Content from sellers you follow", isEnabled: true },
        { id: 'invstScan', label: "Invst Scan", description: "Sellers open for investment", isEnabled: true },
    ]
};
...
const users: User[] = [
    ...
    { id: 'user-2', name: 'Alice Buyer', avatarUrl: 'https://i.pravatar.cc/150?u=alice', persona: 'Buyer', designation: 'Procurement Head', company: 'Global Retail', role: 'Admin', personalEmail: 'alice@personal.com', isPersonalEmailVerified: true, businessEmail: 'alice@globalretail.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, connections: ['seller-1', 'seller-4', 'seller-5', 'user-12'], savedSellers: ['seller-2', 'seller-3'], password: 'password123', enterpriseId: 'ent-2', referralCode: 'HYPER-ALICE456', referrals: [], monthlyReferralEarnings: [], isDormant: false, transactionHistory: [{ id: 'txn-join-2', date: '2023-01-01T10:00:00Z', description: 'Platform Joining Fee', amount: -99, status: 'paid' }], paymentMethods: [{ id: 'pm-1', type: 'Card', provider: 'Visa', last4: '1234' }, { id: 'pm-2', type: 'Netbanking', provider: 'HDFC Bank', last4: '5678' }], preferredPaymentMethodId: 'pm-1', interests: { industry: ['Retail', 'Consumer Goods'], geography: ['North America'], valueChain: ['Sourcing', 'Retail'], offering: ['Physical Product'] } },

    // Enterprise: Innovate Solutions (Seller)
    { id: 'user-3', name: 'Bob Seller', avatarUrl: 'https://i.pravatar.cc/150?u=bob', persona: 'Seller', designation: 'CEO', company: 'Innovate Solutions', role: 'Admin', personalEmail: 'bob@personal.com', isPersonalEmailVerified: true, businessEmail: 'bob@innovate.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, connections: ['seller-2', 'user-2', 'user-4'], password: 'password123', enterpriseId: 'ent-1', referralCode: 'HYPER-BOB789', referrals: [], monthlyReferralEarnings: [], isDormant: false, messageCredits: { remaining: 10, resetsAt: new Date(new Date().getFullYear(), new Date().getMonth() + 1, 1).toISOString() }, transactionHistory: [{ id: 'txn-join-3', date: '2023-01-01T10:00:00Z', description: 'Platform Joining Fee', amount: -4999, status: 'paid' }], paymentMethods: [{ id: 'pm-3', type: 'Card', provider: 'Mastercard', last4: '9876' }], preferredPaymentMethodId: 'pm-3', interests: { industry: ['Technology', 'Logistics'], geography: ['North America', 'Europe', 'Asia'], valueChain: ['Logistics', 'Sourcing'], offering: ['SaaS Platform'] } },
    { id: 'user-5', name: 'Eve Engineer', avatarUrl: 'https://i.pravatar.cc/150?u=eve', persona: 'Collaborator', designation: 'Lead Developer', company: 'Innovate Solutions', role: 'Member', personalEmail: 'eve@personal.com', isPersonalEmailVerified: true, businessEmail: 'eve@innovate.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', enterpriseId: 'ent-1', referralCode: 'HYPER-EVE101', referrals: [], monthlyReferralEarnings: [], isDormant: false, transactionHistory: [], paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Technology', 'Logistics'], geography: ['North America', 'Europe'], valueChain: ['Manufacturing', 'R&D'], offering: ['Software'] } },

    // Independent Users
    { id: 'user-4', name: 'Charlie Investor', avatarUrl: 'https://i.pravatar.cc/150?u=charlie', persona: 'Investor', designation: 'Partner', company: 'Venture Capital Inc.', role: 'Member', personalEmail: 'charlie@personal.com', isPersonalEmailVerified: true, businessEmail: 'charlie@vc.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', walletBalance: 25000, transactionHistory: [{ id: 't1', date: new Date().toISOString(), description: 'Initial Balance', amount: 25000, status: 'paid' }], connections: ['seller-3', 'seller-4', 'seller-6'], savedSellers: ['seller-1', 'seller-7', 'seller-8'], referralCode: 'HYPER-CHARLIE112', referrals: [], monthlyReferralEarnings: [], isDormant: false, paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Technology', 'Finance', 'Healthcare'], geography: ['North America'], valueChain: ['R&D'], offering: ['SaaS Platform'] } },
    { id: 'user-6', name: 'Frank Finance', avatarUrl: 'https://i.pravatar.cc/150?u=frank', persona: 'Browser', designation: 'Analyst', company: 'Independent', role: 'Member', personalEmail: 'frank@personal.com', isPersonalEmailVerified: true, businessEmail: 'frank@independent.com', isBusinessEmailVerified: true, wantsEmailNotifications: false, password: 'password123', subscriptionPlan: 'Free', referralCode: 'HYPER-FRANK131', referrals: [], monthlyReferralEarnings: [], isDormant: false, transactionHistory: [], paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Finance'], geography: ['Europe'], valueChain: ['Marketing'], offering: ['Service'] } },

    // User with an invite
    { id: 'user-7', name: 'Grace Growth', avatarUrl: 'https://i.pravatar.cc/150?u=grace', persona: 'Buyer', designation: 'Marketing Manager', company: 'Startup Co', role: 'Member', personalEmail: 'grace@personal.com', isPersonalEmailVerified: true, businessEmail: 'grace@startup.co', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', enterpriseInvite: { enterpriseId: 'ent-2', enterpriseName: 'Global Retail' }, subscriptionPlan: 'Basic', walletBalance: 5000, transactionHistory: [], referralCode: 'HYPER-GRACE415', referrals: [], monthlyReferralEarnings: [], isDormant: false, paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Retail', 'Technology'], geography: ['North America'], valueChain: ['Marketing', 'Retail'], offering: ['SaaS Platform'] } },

    // User with a pending join request
    { id: 'user-8', name: 'Harry HR', avatarUrl: 'https://i.pravatar.cc/150?u=harry', persona: 'Collaborator', designation: 'HR Manager', company: 'People First', role: 'Member', personalEmail: 'harry@personal.com', isPersonalEmailVerified: true, businessEmail: 'harry@peoplefirst.com', isBusinessEmailVerified: true, password: 'password123', wantsEmailNotifications: true, referralCode: 'HYPER-HARRY161', referrals: [], monthlyReferralEarnings: [], isDormant: false, transactionHistory: [], paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Technology'], geography: ['Asia'], valueChain: ['Sourcing'], offering: ['Service'] } },

    // Additional users for engagement
    { id: 'user-9', name: 'Diana Developer', avatarUrl: 'https://i.pravatar.cc/150?u=diana', persona: 'Collaborator', designation: 'Software Engineer', company: 'Code Crafters', role: 'Member', personalEmail: 'diana@personal.com', isPersonalEmailVerified: true, businessEmail: 'diana@codecrafters.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Free', referralCode: 'HYPER-DIANA718', referrals: [], monthlyReferralEarnings: [], isDormant: false, transactionHistory: [{ id: 'txn-join-9', date: '2023-01-01T10:00:00Z', description: 'Platform Joining Fee', amount: -99, status: 'paid' }], paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Technology'], geography: ['Europe'], valueChain: ['Design', 'R&D'], offering: ['Software', 'SaaS Platform'] } },
    { id: 'user-10', name: 'Mike Manager', avatarUrl: 'https://i.pravatar.cc/150?u=mike', persona: 'Buyer', designation: 'Operations Manager', company: 'QuickLogistics', role: 'Member', personalEmail: 'mike@personal.com', isPersonalEmailVerified: true, businessEmail: 'mike@quicklogistics.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', walletBalance: 12000, transactionHistory: [], connections: ['seller-1', 'seller-7'], referralCode: 'HYPER-MIKE192', referrals: [], monthlyReferralEarnings: [], isDormant: false, paymentMethods: [], preferredPaymentMethodId: undefined, interests: { industry: ['Logistics', 'Retail'], geography: ['Europe', 'North America'], valueChain: ['Logistics'], offering: ['Service'] } },

    // --- SYNTHETIC USERS FOR SCANNER --- //
    { id: 'user-11', name: 'Ivy Investor', avatarUrl: 'https://i.pravatar.cc/150?u=ivy', persona: 'Investor', designation: 'Analyst', company: 'Capital Growth', role: 'Member', personalEmail: 'ivy@personal.com', isPersonalEmailVerified: true, businessEmail: 'ivy@capitalgrowth.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-IVY201', interests: { industry: ['Healthcare', 'Energy'], geography: ['North America', 'Europe'], valueChain: ['R&D'], offering: ['SaaS Platform'] }, connections: ['seller-6'] },
    { id: 'user-12', name: 'Jack Buyer', avatarUrl: 'https://i.pravatar.cc/150?u=jack', persona: 'Buyer', designation: 'Supply Chain Manager', company: 'MegaCorp', role: 'Member', personalEmail: 'jack@personal.com', isPersonalEmailVerified: true, businessEmail: 'jack@megacorp.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-JACK202', interests: { industry: ['Industrial', 'Automotive'], geography: ['Asia'], valueChain: ['Manufacturing', 'Sourcing'], offering: ['Hardware'] }, connections: ['seller-4'] },
    { id: 'user-13', name: 'Kate Collaborator', avatarUrl: 'https://i.pravatar.cc/150?u=kate', persona: 'Collaborator', designation: 'UX Designer', company: 'Creative Designs', role: 'Member', personalEmail: 'kate@personal.com', isPersonalEmailVerified: true, businessEmail: 'kate@creativedesigns.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Free', referralCode: 'HYPER-KATE203', interests: { industry: ['Technology', 'Consumer Goods'], geography: ['Europe'], valueChain: ['Design', 'Marketing'], offering: ['Software'] } },
    { id: 'user-14', name: 'Leo Logistics', avatarUrl: 'https://i.pravatar.cc/150?u=leo', persona: 'Buyer', designation: 'Head of Logistics', company: 'Global Transport', role: 'Member', personalEmail: 'leo@personal.com', isPersonalEmailVerified: true, businessEmail: 'leo@globaltransport.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-LEO204', interests: { industry: ['Logistics', 'Retail'], geography: ['South America', 'Africa'], valueChain: ['Logistics', 'After-Sales Support'], offering: ['Service'] } },
    { id: 'user-15', name: 'Mia Marketing', avatarUrl: 'https://i.pravatar.cc/150?u=mia', persona: 'Collaborator', designation: 'Marketing Lead', company: 'Innovate Solutions', enterpriseId: 'ent-1', role: 'Member', personalEmail: 'mia@personal.com', isPersonalEmailVerified: true, businessEmail: 'mia@innovate.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-MIA205', interests: { industry: ['Technology', 'Logistics'], geography: ['North America'], valueChain: ['Marketing'], offering: ['SaaS Platform'] } },
    { id: 'user-16', name: 'Nate Investor', avatarUrl: 'https://i.pravatar.cc/150?u=nate', persona: 'Investor', designation: 'VC Partner', company: 'Future Ventures', role: 'Member', personalEmail: 'nate@personal.com', isPersonalEmailVerified: true, businessEmail: 'nate@futureventures.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-NATE206', interests: { industry: ['Technology', 'Agriculture'], geography: ['Asia', 'Australia'], valueChain: ['R&D'], offering: ['SaaS Platform', 'Hardware'] } },
    { id: 'user-17', name: 'Olivia Operations', avatarUrl: 'https://i.pravatar.cc/150?u=olivia', persona: 'Buyer', designation: 'Operations Chief', company: 'Fine Foods Inc.', role: 'Member', personalEmail: 'olivia@personal.com', isPersonalEmailVerified: true, businessEmail: 'olivia@finefoods.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-OLIVIA207', interests: { industry: ['Consumer Goods', 'Agriculture'], geography: ['North America'], valueChain: ['Sourcing', 'Retail'], offering: ['Physical Product'] }, connections: ['seller-5'] },
    { id: 'user-18', name: 'Peter Product', avatarUrl: 'https://i.pravatar.cc/150?u=peter', persona: 'Collaborator', designation: 'Product Manager', company: 'Appify', role: 'Member', personalEmail: 'peter@personal.com', isPersonalEmailVerified: true, businessEmail: 'peter@appify.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Free', referralCode: 'HYPER-PETER208', interests: { industry: ['Technology'], geography: ['Europe'], valueChain: ['Design', 'R&D'], offering: ['Software', 'SaaS Platform'] } },
    { id: 'user-19', name: 'Quinn Quality', avatarUrl: 'https://i.pravatar.cc/150?u=quinn', persona: 'Collaborator', designation: 'QA Engineer', company: 'NextGen Robotics', role: 'Member', personalEmail: 'quinn@personal.com', isPersonalEmailVerified: true, businessEmail: 'quinn@nextgenrobotics.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-QUINN209', interests: { industry: ['Automotive', 'Industrial'], geography: ['Asia'], valueChain: ['Manufacturing', 'After-Sales Support'], offering: ['Hardware'] } },
    { id: 'user-20', name: 'Rachel R&D', avatarUrl: 'https://i.pravatar.cc/150?u=rachel', persona: 'Collaborator', designation: 'Research Scientist', company: 'Quantum Leap AI', role: 'Member', personalEmail: 'rachel@personal.com', isPersonalEmailVerified: true, businessEmail: 'rachel@quantumleapai.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-RACHEL210', interests: { industry: ['Healthcare', 'Technology'], geography: ['North America'], valueChain: ['R&D'], offering: ['Software'] } },
    { id: 'user-21', name: 'Sam Sales', avatarUrl: 'https://i.pravatar.cc/150?u=sam', persona: 'Seller', designation: 'Sales Director', company: 'DataWeave Analytics', role: 'Member', personalEmail: 'sam@personal.com', isPersonalEmailVerified: true, businessEmail: 'sam@dataweave.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-SAM211', interests: { industry: ['Finance', 'Technology'], geography: ['Europe'], valueChain: ['Marketing', 'Retail'], offering: ['SaaS Platform'] } },
    { id: 'user-22', name: 'Tom Tech', avatarUrl: 'https://i.pravatar.cc/150?u=tom', persona: 'Buyer', designation: 'IT Procurement', company: 'Enterprise Solutions', role: 'Member', personalEmail: 'tom@personal.com', isPersonalEmailVerified: true, businessEmail: 'tom@enterprisesolutions.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-TOM212', interests: { industry: ['Technology'], geography: ['North America', 'Europe'], valueChain: ['Sourcing'], offering: ['Software', 'Hardware', 'SaaS Platform'] } },
    { id: 'user-23', name: 'Ursula Urban', avatarUrl: 'https://i.pravatar.cc/150?u=ursula', persona: 'Investor', designation: 'Angel Investor', company: 'Self-employed', role: 'Member', personalEmail: 'ursula@personal.com', isPersonalEmailVerified: true, businessEmail: 'ursula@angel.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-URSULA213', interests: { industry: ['Logistics', 'Retail', 'Consumer Goods'], geography: ['Europe'], valueChain: ['Retail', 'Marketing'], offering: ['Service', 'Physical Product'] }, connections: ['seller-7'] },
    { id: 'user-24', name: 'Victor Venture', avatarUrl: 'https://i.pravatar.cc/150?u=victor', persona: 'Investor', designation: 'Principal', company: 'Venture Capital Inc.', role: 'Member', personalEmail: 'victor@personal.com', isPersonalEmailVerified: true, businessEmail: 'victor@vc.com', isBusinessEmailVerified: true, wantsEmailNotifications: true, password: 'password123', subscriptionPlan: 'Pro', referralCode: 'HYPER-VICTOR214', interests: { industry: ['Technology', 'Finance'], geography: ['North America'], valueChain: ['R&D'], offering: ['SaaS Platform'] }, connections: ['seller-1', 'seller-3'] },
    { id: 'user-25', name: 'Wendy Web', avatarUrl: 'https://i.pravatar.cc/150?u=wendy', persona: 'Browser', designation: 'Student', company: 'University', role: 'Member', personalEmail: 'wendy@personal.com', isPersonalEmailVerified: true, businessEmail: 'wendy@university.edu', isBusinessEmailVerified: true, wantsEmailNotifications: false, password: 'password123', subscriptionPlan: 'Free', referralCode: 'HYPER-WENDY215', interests: { industry: ['Technology'], geography: ['Australia'], valueChain: ['Design'], offering: ['Software'] } },
];
...
const mockDueDiligenceData1: DueDiligenceData = {
    ...
    financials: {
        statements: [
            {
                year: 2023,
                revenue: 100000000, cogs: 40000000, grossProfit: 60000000, operatingExpenses: 30000000, ebitda: 30000000, netIncome: 21000000,
                cashAndEquivalents: 15000000, totalAssets: 80000000, currentLiabilities: 20000000, longTermDebt: 5000000, totalLiabilities: 25000000, equity: 55000000,
                operatingCashFlow: 25000000, investingCashFlow: -5000000, financingCashFlow: 2000000, netChangeInCash: 22000000
            },
            {
                year: 2022,
                revenue: 80000000, cogs: 35000000, grossProfit: 45000000, operatingExpenses: 28000000, ebitda: 17000000, netIncome: 12000000,
                cashAndEquivalents: 10000000, totalAssets: 65000000, currentLiabilities: 18000000, longTermDebt: 6000000, totalLiabilities: 24000000, equity: 41000000,
                operatingCashFlow: 15000000, investingCashFlow: -4000000, financingCashFlow: 1000000, netChangeInCash: 12000000
            },
            {
                year: 2021,
                revenue: 55000000, cogs: 25000000, grossProfit: 30000000, operatingExpenses: 25000000, ebitda: 5000000, netIncome: 3000000,
                cashAndEquivalents: 5000000, totalAssets: 40000000, currentLiabilities: 15000000, longTermDebt: 7000000, totalLiabilities: 22000000, equity: 18000000,
                operatingCashFlow: 4000000, investingCashFlow: -3000000, financingCashFlow: 5000000, netChangeInCash: 6000000
            }
        ],
        keyRatios: [
            { name: 'Gross Margin', businessValue: '60%', industryAverage: '55%', competitor1: '58%', competitor2: '52%', isFinancial: true },
            { name: 'Operating Margin', businessValue: '30%', industryAverage: '25%', competitor1: '28%', competitor2: '22%', isFinancial: true },
            { name: 'Net Profit Margin', businessValue: '21%', industryAverage: '15%', competitor1: '18%', competitor2: '12%', isFinancial: true },
            { name: 'Burn Rate', businessValue: '$250k/mo', industryAverage: '$300k/mo', competitor1: '$280k/mo', competitor2: '$350k/mo', isFinancial: true },
            { name: 'Cash Runway', businessValue: '18 mo', industryAverage: '12 mo', competitor1: '14 mo', competitor2: '10 mo', isFinancial: true },
            { name: 'Current Ratio', businessValue: '2.5', industryAverage: '1.8', competitor1: '2.0', competitor2: '1.5', isFinancial: true },
            { name: 'Debt-to-Equity', businessValue: '0.45', industryAverage: '0.6', competitor1: '0.5', competitor2: '0.7', isFinancial: true }
        ],
        revenueBreakdown: {
            recurring: 80,
            oneTime: 20,
            sources: [{ name: 'SaaS Subscriptions', value: 80 }, { name: 'Consulting', value: 20 }],
            historicGrowth: [{ year: 2021, revenue: 55000000 }, { year: 2022, revenue: 80000000 }, { year: 2023, revenue: 100000000 }]
        },
        risks: [
            { id: 'risk1', label: 'Market Competition', value: 'High competition from established players like LogiNext.', showOnIntroCard: false },
            { id: 'risk2', label: 'Overdue Receivables', value: '15% of AR > 90 days due to supply chain delays.', showOnIntroCard: false }
        ]
    },
    commercials: {
        marketOverview: {
            size: '$12.5B',
            cagr: '10.5%',
            trends: ['AI adoption in logistics', 'Demand for real-time visibility', 'Green logistics'],
            segments: ['Large Enterprise Retail', '3PL Providers', 'Manufacturing']
        },
        customerMetrics: {
            count: 50,
            cac: '₹50 Lakh',
        ...
        mainCompetitors: [{ name: 'LogiNext', marketShare: '5%', uvp: 'Wider network coverage' }, { name: 'FourKites', marketShare: '8%', uvp: 'Stronger brand recognition' }],
        salesPipeline: {
            topClients: ['Global Retail', 'FastShip Logistics', 'MegaCorp Mfg'],
            conversionRates: '15% (Lead to Deal)',
            revenueConcentration: 'High: Top 3 clients account for 40% of revenue.'
        },
        competitiveLandscape: [
            { name: 'Pricing Model', businessValue: 'Subscription', industryAverage: 'Mixed', competitor1: 'Per Transaction', competitor2: 'License', isFinancial: false },
            { name: 'Tech Stack', businessValue: 'Modern (React/Node)', industryAverage: 'Legacy', competitor1: 'Modern', competitor2: 'Legacy', isFinancial: false },
            { name: 'Customer Support', businessValue: '24/7 Dedicated', industryAverage: 'Email Only', competitor1: '24/7 Chat', competitor2: 'Phone Support', isFinancial: false },
            { name: 'Brand Awareness', businessValue: 'Growing', industryAverage: 'Moderate', competitor1: 'High', competitor2: 'Very High', isFinancial: false }
        ]
    },
    funding: {
...
const mockDueDiligenceData2: DueDiligenceData = {
    ...
    financials: {
        statements: [
            {
                year: 2023,
                revenue: 250000000, cogs: 50000000, grossProfit: 200000000, operatingExpenses: 120000000, ebitda: 80000000, netIncome: 60000000,
                cashAndEquivalents: 40000000, totalAssets: 150000000, currentLiabilities: 40000000, longTermDebt: 0, totalLiabilities: 40000000, equity: 110000000,
                operatingCashFlow: 70000000, investingCashFlow: -10000000, financingCashFlow: 0, netChangeInCash: 60000000
            },
            {
                year: 2022,
                revenue: 180000000, cogs: 40000000, grossProfit: 140000000, operatingExpenses: 100000000, ebitda: 40000000, netIncome: 30000000,
                cashAndEquivalents: 20000000, totalAssets: 110000000, currentLiabilities: 30000000, longTermDebt: 5000000, totalLiabilities: 35000000, equity: 75000000,
                operatingCashFlow: 35000000, investingCashFlow: -5000000, financingCashFlow: 0, netChangeInCash: 30000000
            },
            {
                year: 2021,
                revenue: 100000000, cogs: 25000000, grossProfit: 75000000, operatingExpenses: 70000000, ebitda: 5000000, netIncome: 2000000,
                cashAndEquivalents: 10000000, totalAssets: 80000000, currentLiabilities: 20000000, longTermDebt: 10000000, totalLiabilities: 30000000, equity: 50000000,
                operatingCashFlow: 5000000, investingCashFlow: -2000000, financingCashFlow: 5000000, netChangeInCash: 8000000
            }
        ],
        keyRatios: [
            { name: 'Gross Margin', businessValue: '80%', industryAverage: '75%', competitor1: '78%', competitor2: '72%', isFinancial: true },
            { name: 'Net Profit Margin', businessValue: '24%', industryAverage: '20%', competitor1: '22%', competitor2: '18%', isFinancial: true },
            { name: 'Burn Rate', businessValue: '$0', industryAverage: '$50k/mo', competitor1: '$20k/mo', competitor2: '$100k/mo', isFinancial: true },
            { name: 'Current Ratio', businessValue: '3.0', industryAverage: '2.0', competitor1: '2.5', competitor2: '1.8', isFinancial: true }
        ],
        revenueBreakdown: {
            recurring: 90,
            oneTime: 10,
            sources: [{ name: 'Enterprise Licenses', value: 90 }, { name: 'Data APIs', value: 10 }],
            historicGrowth: [{ year: 2021, revenue: 100000000 }, { year: 2022, revenue: 180000000 }, { year: 2023, revenue: 250000000 }]
        },
        risks: [
            { id: 'risk1', label: 'Model Accuracy', value: 'Dependent on continuous model training and data quality.', showOnIntroCard: false },
            { id: 'risk2', label: 'Liability', value: 'Pending lawsuit regarding IP infringement (low risk).', showOnIntroCard: false }
        ]
    },
    commercials: {
        marketOverview: {
            size: '$12B',
            cagr: '15%',
            trends: ['Algorithmic trading growth', 'Demand for alternative data', 'Cloud migration'],
            segments: ['Hedge Funds', 'Investment Banks', 'Asset Managers']
        },
        customerMetrics: {
            count: 25,
            cac: '₹20 Lakh',
        ...
        mainCompetitors: [{ name: 'AlphaSense', marketShare: '10%', uvp: 'Larger data library' }, { name: 'QuantConnect', marketShare: '4%', uvp: 'Open-source platform' }],
        salesPipeline: {
            topClients: ['Goldman Sachs', 'Morgan Stanley', 'BlackRock'],
            conversionRates: '10% (Lead to Deal)',
            revenueConcentration: 'Top 5 clients make up 60% of revenue.'
        },
        competitiveLandscape: [
            { name: 'Data Sources', businessValue: 'Traditional + Alt', industryAverage: 'Traditional', competitor1: 'Broad', competitor2: 'User Gen', isFinancial: false },
            { name: 'Deployment', businessValue: 'Cloud Native', industryAverage: 'Hybrid', competitor1: 'Cloud', competitor2: 'On-Prem', isFinancial: false },
            { name: 'Ease of Use', businessValue: 'High', industryAverage: 'Medium', competitor1: 'Medium', competitor2: 'Low', isFinancial: false }
        ]
    },
    funding: {
        timeline: [
...
const posts: Post[] = [
    ...
    { id: 'post-6', sellerId: 'seller-6', solutionId: 'sol-6', title: 'Early Detection Saves Lives', content: '<p>Our AI diagnostic tool is now being trialed in 5 hospitals, helping radiologists spot anomalies faster than ever before.</p>', media: [{ type: 'image', url: 'https://picsum.photos/seed/post-6/800/600' }], likes: 95, comments: [], bookmarks: 15, timestamp: '6 days ago', isLiked: false, isBookmarked: false },
    { id: 'post-7', sellerId: 'seller-7', solutionId: 'sol-7', title: 'Drone Delivery Network Expands to London', content: '<p>We are excited to announce the launch of our last-mile drone delivery service in London! Expect delivery times under 20 minutes.</p>', media: [{ type: 'image', url: 'https://picsum.photos/seed/post-7/800/600' }], likes: 220, comments: [], bookmarks: 50, timestamp: '1 week ago', isLiked: true, isBookmarked: true },
    ...
    { id: 'post-10', sellerId: 'seller-3', solutionId: 'sol-3', title: 'Market Volatility on the Rise', content: '<p>Our platform is detecting increased volatility in the energy sector. Clients can log in to view our detailed forecast and recommendations.</p>', media: [{ type: 'image', url: 'https://picsum.photos/seed/post-10/800/600' }], likes: 190, comments: [], bookmarks: 41, timestamp: '2 weeks ago', isLiked: false, isBookmarked: true },
    ...
    { id: 'post-12', sellerId: 'seller-4', solutionId: 'sol-4', title: 'Productivity Gains: A New Case Study', content: 'See how we helped a major auto manufacturer boost their production by 25%.', media: [{ type: 'image', url: 'https://picsum.photos/seed/post-12/800/600' }], sharedContent: { type: 'caseStudy', item: caseStudies[1] }, likes: 280, comments: [], bookmarks: 75, timestamp: '8 hours ago', isLiked: false, isBookmarked: false },
...
const inboxItems: InboxItem[] = [
    { id: 'inbox-1', category: 'MeetingRequest', fromUser: users[1], content: 'Interested in a demo of your AI platform.', timestamp: new Date(Date.now() - 86400000).toISOString(), status: 'Pending', relatedSellerId: 'seller-1', meetingDetails: { message: 'Can we connect sometime next week to discuss our logistics needs?', proposedTime: '2024-08-05T10:00', status: 'pending' } },
    ...
    { id: 'inbox-3', category: 'SalesEnquiry', fromUser: users[9], content: 'What is the pricing model for the Predictive Market Analysis platform?', timestamp: new Date(Date.now() - 172800000).toISOString(), status: 'Pending', relatedSellerId: 'seller-3' },
    { id: 'inbox-4', category: 'MeetingRequest', fromUser: users[1], content: 'We are looking to automate our assembly line.', timestamp: new Date(Date.now() - 259200000).toISOString(), status: 'Pending', relatedSellerId: 'seller-4', meetingDetails: { message: 'We were impressed by your video. We would like to schedule a technical consultation.', proposedTime: '2024-08-08T14:00', status: 'pending' } },
    ...
    { id: 'inbox-6', category: 'CollaborationRequest', fromUser: users[8], content: 'We see a potential synergy between our companies.', timestamp: new Date(Date.now() - 345600000).toISOString(), status: 'Pending', relatedSellerId: 'seller-7' },
...
const enterprisesData: Enterprise[] = [
    { id: 'ent-1', companyName: 'Innovate Solutions', address: '123 Tech Park, Mumbai', entityType: 'Private entity', gstNumber: 'GSTIN123', persona: 'Seller', subscriptionPlan: 'Pro', associationCode: 'INNOV8', members: ['user-3', 'user-5', 'user-15'], pendingMembers: ['user-8'], location: { lat: 19.0760, lng: 72.8777, city: 'Mumbai', country: 'India' } },
...
const recentActivityForDashboard: (Enquiry | MeetingRequest)[] = mockInboxItems.slice(0, 5).map(item => {
    ...
    if (item.category === 'MeetingRequest' && item.meetingDetails) {
        return {
            ...base,
...
export const mockDashboardData = {
    ...
    engagedCompanies: [{ id: 'comp-1', name: 'Global Retail', logoUrl: 'https://ui-avatars.com/api/?name=Global+Retail&background=10B981&color=fff&size=150', sector: 'Retail', employees: 10000 }]
};
