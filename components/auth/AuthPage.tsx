    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-light dark:bg-brand-dark p-4">
      <div className="w-full max-w-lg bg-brand-card rounded-xl shadow-lg border border-brand-border">
        ...
        <div className="flex border-b border-brand-border">
          ...
          <button id="tab-signup" onClick={() => { setMode('signup'); setSubview('options'); }} className={`w-full py-3 font-semibold border-b-2 transition-colors ${mode === 'signup' ? 'border-brand-primary text-brand-primary' : 'border-transparent text-gray-500 hover:text-brand-primary'}`}>Sign Up</button>
        </div>
