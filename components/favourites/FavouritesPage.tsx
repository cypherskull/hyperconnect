                        ...
                        {bookmarkedPosts.map(post => {
                            ...
                            return (
                                <Post 
                                    ...
                                    onMessage={() => showToast('info', 'Not Implemented', "Message action from this view not implemented.")}
                                    onMeeting={() => showToast('info', 'Not Implemented', "Meeting action from this view not implemented.")}
                                />
                            );
                        })}
                    </div>
