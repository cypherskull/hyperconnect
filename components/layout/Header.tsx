        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center justify-end sm:space-x-1">
            {accessConfig.canViewFeed && (
              <button id="nav-home" onClick={() => onNavigate('feed')} className="flex items-center justify-center p-2 sm:flex-col sm:w-16 sm:h-16 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-brand-primary transition-colors rounded-lg" aria-label="Home" title="Home">
                <HomeIcon className="w-6 h-6" />
                <span className="text-[10px] font-semibold mt-1 hidden sm:block">Home</span>
              </button>
            )}
            {accessConfig.canUseFavourites && (
              <button id="nav-favourites" onClick={() => onNavigate('favourites')} className="flex items-center justify-center p-2 sm:flex-col sm:w-16 sm:h-16 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-brand-primary transition-colors rounded-lg" aria-label="Favourites" title="Favourites">
                <StarIcon className="w-6 h-6" />
                <span className="text-[10px] font-semibold mt-1 hidden sm:block">Favourites</span>
              </button>
            )}
            {accessConfig.canUseInbox && (
              <button id="nav-inbox" onClick={() => onNavigate('inbox')} className="flex items-center justify-center p-2 sm:flex-col sm:w-16 sm:h-16 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-brand-primary transition-colors rounded-lg" aria-label="Inbox" title="Inbox">
                <EnvelopeIcon className="w-6 h-6" />
                <span className="text-[10px] font-semibold mt-1 hidden sm:block">Inbox</span>
              </button>
            )}
            <button id="nav-network" onClick={() => onNavigate('network')} className="flex items-center justify-center p-2 sm:flex-col sm:w-16 sm:h-16 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-brand-primary transition-colors rounded-lg" aria-label="Network" title="Network">
