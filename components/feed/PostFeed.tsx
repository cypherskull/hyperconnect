                ...
                {posts.length > 0 ? posts.map(post => {
                    ...
                    return (
                        <Post 
                            ...
                            onMessage={() => showToast('info', 'Not Implemented', "Message action from post not implemented.")}
                            onMeeting={() => showToast('info', 'Not Implemented', "Meeting action from post not implemented.")}
                        />
                    );
                }) : (
