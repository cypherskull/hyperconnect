        ...
        <div className="bg-brand-card rounded-lg shadow-md border border-brand-border">
            <div className="p-4 sm:p-6">
                ...
                <div className="mt-4 flex justify-around items-center text-gray-500 dark:text-gray-400 border-t border-brand-border pt-2">
                    <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); console.log('Liking post from Post.tsx:', post.id); onLikePost(post.id); }} className={`flex flex-col items-center justify-center w-20 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 ${post.isLiked ? 'text-red-500' : ''}`}>
                    ...
                    <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); console.log('Commenting post from Post.tsx:', post.id); onComment(post); }} className="flex flex-col items-center justify-center w-20 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 hover:text-brand-primary">
                        <div className="flex items-center space-x-1">
